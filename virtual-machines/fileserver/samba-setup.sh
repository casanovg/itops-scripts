...
# [global]
       # security = ADS
       # workgroup = HTARGENTINA
       # realm = HTARGENTINA.LAN
...
# [HTA-Files]
       # path = /data/aleph-disk/hta-files
       # read only = no

# [HTA-Users]
       # path = /data/aleph-disk/hta-users
       # read only = no

# [HTA-Root$]
       # path = /data/aleph-disk
       # read only = no
...
#!root = HTARGENTINA\Administrator

# Solve the "Unable to initialize messaging context!" problem
# -----------------------------------------------------------
#mkdir /var/lib/samba/private
#smbclient -L HTA-PDC.htargentina.lan
